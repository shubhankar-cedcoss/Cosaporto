	...
	<div class="hubwoo-box">
		...
		<div class="mwb-heb-wlcm__content">
			...
			<div class="mwb-heb-wlcm__btn-wrap hubwoo-btn-list">
				<a href="javascript:void;" id="hubwoo_create_group_prop_setup" class="hubwoo-btn--primary hubwoo-btn-data" data-action="group_setup" style="display: <?php echo esc_attr( $cta['will_create'] ); ?>"><?php esc_html_e( 'Create Properties and Groups ', 'hubspot-for-woocommerce' ); ?></a>
				<a href="#" id="hubwoo-manage-setup" class="hubwoo-btn--primary hubwoo-btn-data" data-action="group_manage_setup" style="display: <?php echo esc_attr( $cta['did_created'] ); ?>"><?php esc_html_e( 'View Created Properties and Groups ', 'hubspot-for-woocommerce' ); ?></a>
			</div>
											...
											?>
												<div class="mwb-woo__accordion-wrapper">
													...
													if ( 'created' == $single_group['status'] ) {
														...
														<a data-name="<?php echo esc_attr( $single_group['detail']['name'], 'hubspot-for-woocommerce' ); ?>" class="mwb-woo__accordian-heading <?php echo esc_attr( $single_group['detail']['name'] ); ?> <?php echo esc_attr( $anc_class ); ?>" href="#"><?php echo esc_html( $single_group['detail']['displayName'] ); ?></a>
														<?php
													} else {
