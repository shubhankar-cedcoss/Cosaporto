...
<div class="hubwoo-form-wizard-wrapper">
	<div class="hubwoo-form-wizard-content-wrapper">
		...
		<div class="hubwoo-group-wrap__deal_notice deals-par" style="display: <?php echo esc_attr( $display_data['scope_notice'] ); ?>">
			<p class="hubwoo_deals_message sync-desc">
				<?php
					esc_html_e(
		...
		<div class="hubwoo-form-wizard-content hubwoo-deal-wrap-con" data-tab-content="ecommerce-pipleine-setup" style="display: <?php echo esc_attr( $display_data['view_mapping'] ); ?>">
			<div class="hubwoo-deal-wrap-con-flex">
				<div class="hubwoo-deal-wrap-con__h-con">
					...
					<div class="hubwoo-deal-wrap-con__intro" style="display: <?php echo esc_attr( $display_data['h_sync'] ); ?>">
						<?php esc_html_e( 'Connect with HubSpot eCommerce pipleine to create deals for your WooCommerce orders. ', 'hubspot-for-woocommerce' ); ?>
					</div>
				</div>
			...
			<div class="hubwoo-general-settings hubwoo-group-wrap__map_deal_stage ecommerce-pipleine-setup hubwoo-deal-wrap-con__store" style="display: <?php echo esc_attr( $display_data['view_mapping'] ); ?>">
				<button class="hubwoo__btn manage_product_sync" data-action='run-ecomm-setup' style="display: <?php echo esc_attr( $display_data['view_btn_mapping'] ); ?>"> <?php esc_html_e( 'Run Setup', 'hubspot-for-woocommerce' ); ?></button>		
		...
		<div class="hubwoo-form-wizard-content hubwoo-deal-wrap-con" data-tab-content="deal-ocs" style="display: <?php echo esc_attr( $display_data['view_all'] ); ?>">
			<div class="hubwoo-group-wrap__deal_ocs hubwoo-deal-wrap-con">
				...
				<div class="hubwoo-group-wrap__deal_ocs hubwoo-deal-wrap-con__store hubwoo-general-settings" style="display:<?php echo esc_attr( $display_data['message'] ); ?>">
					<div class="hubwoo-group-wrap__deal_notice deals-par" style="display: <?php echo esc_attr( $display_data['message'] ); ?>">
