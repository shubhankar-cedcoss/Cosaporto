	...
	class Hubwoo {
		...
		public function hubwoo_default_tabs() {
			...
			$default_tabs['hubwoo-sync-contacts'] = array(
				'name'       => __( 'Sync', 'hubspot-for-woocommerce' ),
			...
			$default_tabs['error-management'] = array(
				'name'       => __( 'Error Tracking', 'hubspot-for-woocommerce' ),
				'dependency' => '',
				'title'      => esc_html__( 'Track the working of Integration directly from here', 'hubspot-for-woocommerce' ),
			);
